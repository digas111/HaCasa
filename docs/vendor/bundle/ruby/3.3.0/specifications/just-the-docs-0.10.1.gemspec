...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<bundler>.freeze, [">= 2.3.5".freeze])
  s.add_runtime_dependency(%q<jekyll>.freeze, [">= 3.8.5".freeze])
  s.add_runtime_dependency(%q<jekyll-seo-tag>.freeze, [">= 2.0".freeze])
  s.add_runtime_dependency(%q<jekyll-include-cache>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<rake>.freeze, [">= 12.3.1".freeze])
end

...
To get started, set up your [local development workflow](local-development.md), then review the guidelines for [Theme](theme.md) and [Templates](template.md). Additionally, you can check out the template files on [Github](https://github.com/damianeickhoff/HaCasa/tree/main/dashboard/HaCasa/templates) we use to customize and build upon.

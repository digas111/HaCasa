...
1. Install the HaCasa files with HACS.
2. Add the HaCasa dashboard configuration to `configuration.yaml`.

Home Assistant's UI editor does not yet support the include directives used by HaCasa and many other advanced dashboards, so you still need to edit `configuration.yaml`.
